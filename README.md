...
A conversational AI interface for Danish legislation. Ask questions about laws, bills, and parliamentary proceedings in natural language — DK-Law-AI looks up real-time data from [retsinformation.dk](https://retsinformation-api.dk) and answers with proper legal references.
...
DK-Law-AI covers the full [Retsinformation API](https://retsinformation-api.dk/docs):
...
> [!CAUTION]
> **DK-Law-AI is NOT legal advice.**
>
> Responses are generated by an AI model and may contain errors, omissions, or outdated information. **Trust but verify** — always check the official text at [retsinformation.dk](https://www.retsinformation.dk) before relying on any output from this tool. The developers accept no liability for decisions made based on information provided by DK-Law-AI.
